...
export const SidebarLinkGroup: React.FC<SidebarRoute> = ({ title, icon, routes }) => {
    ...
    <div className="relative">
      ...
      >
        <div className="flex items-center">
          {Icon && <Icon className="w-4 h-4 shrink-0 leading-none" />}
        ...
        <div className="flex shrink-0 ml-2">
          <IconChevronRight
            className={`w-3 h-3 duration-300 shrink-0 ml-1 transition ${collapsed && 'rotate-90'}`}
          />
        </div>
      </button>
      <ul
